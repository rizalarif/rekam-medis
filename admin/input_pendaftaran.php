             ...
             <div class="form-group">
                    ...
                    <select name="pasien" class="form-control" required>
                      ...
                      <?php
                              ...
                              $sql1 = mysqli_query($koneksi, "SELECT * FROM tb_pasien WHERE stts='1'");
              ...
              <div class="form-group">
                     ...
                     <select name="dokter" class="form-control" required>
                       ...
                       <?php
                               include '../config/koneksi.php';
                               $sql2 = mysqli_query($koneksi, "SELECT * FROM tb_dokter WHERE stts='1'");
...
if(isset($_POST['kirim'])){
      ...
      $sql1 = mysqli_query ($koneksi, "INSERT INTO tb_pendaftaran VALUES ('', '$pasien', '$dokter',  '$tgl_periksa', '$waktu_pendaftaran','1')");
