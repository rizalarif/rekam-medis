  ...
  <tr>
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="1%" valign="top">:</td>
        <td width="33%" valign="top"><?php $s = $_GET['semester']; 
		echo"$s"; ?></td>
      </tr>
      <tr>
        ...
        <td valign="top">:</td>
        <td valign="top"><?php $thn = $_GET['tahun']; 
		echo"$thn"; ?></td>
      </tr>
      <tr>
...
?>	
      ...
      <tr>
        <td valign="top"><table width="100%" border="1" cellpadding="3" cellspacing="0" bordercolor="#000000">
          <tr>
            ...
            <td width="31%" align="center" valign="top"><?php $skt = $_GET['sakit']; 
		echo"$skt"; ?>
              Hari</td>
          </tr>
          <tr>
            <td align="center" valign="top">Izin</td>
            <td align="center" valign="top"><?php $i = $_GET['izin']; 
		echo"$i"; ?> 
              Hari </td>
          </tr>
          <tr>
            <td align="center" valign="top">Tanpa Keterangan </td>
            <td align="center" valign="top"><?php $tdk = $_GET['tdkmsk']; 
		echo"$tdk"; ?>
              Hari </td>
          </tr>
          <tr>
      ...
      <tr>
        <td valign="top"><?php $tem = $_GET['tempat']; 
		echo"$tem"; ?>
          ,
		  <?php
				$bln = date('m');
      ...
      <tr>
        <td align="center" valign="middle"><p><?php $kep = $_GET['kepsek']; 
		echo"$kep"; ?></p></td>
      </tr>
      <tr>
        <td align="center" valign="top">NIP.<?php $nip = $_GET['nip']; 
		echo"$nip"; ?></td>
      </tr>
      <tr>
